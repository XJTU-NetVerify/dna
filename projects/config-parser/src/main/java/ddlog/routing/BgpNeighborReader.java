...
public final class BgpNeighborReader
{
    protected BgpNeighborReader(ddlog.__routing.BgpNeighbor inner) { this.inner = inner; }
    private ddlog.__routing.BgpNeighbor inner;
